using Tyuiu.TyanVA.Sprint0.Task7.V0.Lib;

namespace Tyuiu.TyanVA.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Тян В.А | ИБКСб-26-1";
            ...
            Console.WriteLine("* Выполнил: Тян В.А | ИБКСб-26-1                                          *");
            Console.WriteLine("***************************************************************************");
